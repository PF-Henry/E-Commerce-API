...
const { Products, Categories, Images, Orders, Orders_Items, Reviews, Users, Brands, Roles, Permissions } = sequelize.models;
...
Products.hasMany(Orders_Items);
Orders_Items.belongsTo(Products);
