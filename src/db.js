...
const { Products, Categories, Images, Orders, OrdersItems, Reviews, Users, Brands, Roles, Permissions } = sequelize.models;
...
Products.hasMany(OrdersItems);
OrdersItems.belongsTo(Products);
